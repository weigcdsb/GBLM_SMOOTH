...
sim.stp_Ns = 50;
sim.stp_tau= 1;
sim.stp_B = [0 1 2 3 4]'*-.05;
sim.hist_tau = .01;
sim.hist_beta = -1;
sim.wt_long = wtLongAdjust(1.5, sim) + ...
    detrend(cumsum(randn(sim.vecN,1)*sqrt(1e-5)));
